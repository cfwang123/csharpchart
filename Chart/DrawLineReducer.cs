...
public struct DrawLineReducer2 {
	public Graphics sdc;
	public Bitmap bmp;
	public Pen pen;
	public bool hasLine;
	...
	public DrawLineReducer2(Graphics sdc, Bitmap bmp, Pen pen, Rectangle rGrid) : this() {
		this.sdc = sdc;
		this.pen = pen;
		this.rGrid = rGrid;
		this.bmp = bmp;
...
public struct DrawLineReducer {
	...
	public DrawLineReducer(Graphics sdc, Bitmap bmp, Pen pen, Rectangle rGrid) : this() {
		this.sdc = sdc;
		this.pen = pen;
		this.rGrid = rGrid;
		this.bmp = bmp;
